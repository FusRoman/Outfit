...
fn test_diff_cor_nbody_nonregression() {
    ...
    // -------------------------------------------------------------------------
    {
        ...
        let expected = OrbitalElements::Equinoctial {
            elements: EquinoctialElements {
                reference_epoch: 60672.2443617134,
                semi_major_axis: 3.2068523500875683,
                eccentricity_sin_lon: 0.053350222152757976,
                eccentricity_cos_lon: -0.023244915216062555,
                tan_half_incl_sin_node: 0.002892763177270836,
                tan_half_incl_cos_node: 0.0918012782243908,
                mean_longitude: 0.6263405546640604,
            },
            uncertainty: Some(EquinoctialUncertainty {
                semi_major_axis: 0.007578260303366644,
                eccentricity_sin_lon: 0.0024781020167917596,
                eccentricity_cos_lon: 0.0007444159765511998,
                tan_half_incl_sin_node: 4.2781218908020626e-5,
                tan_half_incl_cos_node: 5.70757178257223e-5,
                mean_longitude: 0.0033343596033833774,
            }),
            covariance: Some(OrbitalCovariance {
                matrix: [
                    [
                        5.7430029225582706e-5,
                        1.8715374770805263e-5,
                        5.600863787034983e-6,
                        -3.235464794524021e-7,
                        -4.2954119646279103e-7,
                        2.5032700873414244e-5,
                    ],
                    [
                        1.871537477080526e-5,
                        6.140989605627387e-6,
                        1.807035063937061e-6,
                        -1.0561214167496014e-7,
                        -1.4093669906746457e-7,
                        8.250844287095398e-6,
                    ],
                    [
                        5.600863787034982e-6,
                        1.8070350639370601e-6,
                        5.541551461446766e-7,
                        -3.147960113278946e-8,
                        -4.1482175200122896e-8,
                        2.4009397865986993e-6,
                    ],
                    [
                        -3.2354647945240193e-7,
                        -1.0561214167496008e-7,
                        -3.1479601132789444e-8,
                        1.8302326912559813e-9,
                        2.436272754731174e-9,
                        -1.4141265694676898e-7,
                    ],
                    [
                        -4.2954119646279044e-7,
                        -1.4093669906746451e-7,
                        -4.1482175200122876e-8,
                        2.436272754731174e-9,
                        3.2576375653214748e-9,
                        -1.893459316010111e-7,
                    ],
                    [
                        2.5032700873414207e-5,
                        8.250844287095396e-6,
                        2.4009397865986997e-6,
                        -1.41412656946769e-7,
                        -1.893459316010111e-7,
                        1.1117953964674955e-5,
                    ],
                ]
                .into(),
            }),
        ...
        assert_relative_eq!(orbit.orbit_quality(), 0.34513272005725076, epsilon = tol);
    }
    ...
    // -------------------------------------------------------------------------
    {
        ...
        let expected = OrbitalElements::Equinoctial {
            elements: EquinoctialElements {
                reference_epoch: 60465.26777915681,
                semi_major_axis: 2.1907336797978263,
                eccentricity_sin_lon: -0.13402964564099973,
                eccentricity_cos_lon: 0.15339654626583657,
                tan_half_incl_sin_node: 0.00300157711868628,
                tan_half_incl_cos_node: -0.05948148805069252,
                mean_longitude: 4.22481233391827,
            },
            uncertainty: Some(EquinoctialUncertainty {
                semi_major_axis: 2.1407292917199492e-5,
                eccentricity_sin_lon: 1.3647087243489258e-5,
                eccentricity_cos_lon: 5.318485366979754e-6,
                tan_half_incl_sin_node: 3.449544893977396e-7,
                tan_half_incl_cos_node: 8.50340842773946e-7,
                mean_longitude: 2.6641193883476546e-5,
            }),
            covariance: Some(OrbitalCovariance {
                matrix: [
                    [
                        4.582721900427796e-10,
                        -2.4449197535632915e-10,
                        7.206606423619214e-11,
                        -1.883008414563167e-12,
                        -6.327553234718561e-12,
                        4.3458425851834325e-10,
                    ],
                    [
                        -2.444919753563295e-10,
                        1.8624299023140722e-10,
                        -6.033076327907409e-11,
                        7.979984851401071e-15,
                        -6.597996975766813e-13,
                        -3.5828010144645735e-10,
                    ],
                    [
                        7.206606423619221e-11,
                        -6.033076327907409e-11,
                        2.828628659877777e-11,
                        2.0424365732296877e-14,
                        1.4220013552627238e-13,
                        1.275779736097027e-10,
                    ],
                    [
                        -1.883008414563166e-12,
                        7.979984851400945e-15,
                        2.0424365732296877e-14,
                        1.189935997556552e-13,
                        2.643047640334246e-13,
                        3.756470993663438e-13,
                    ],
                    [
                        -6.327553234718558e-12,
                        -6.597996975766814e-13,
                        1.4220013552627236e-13,
                        2.6430476403342455e-13,
                        7.230795488895048e-13,
                        2.605254262672039e-12,
                    ],
                    [
                        4.345842585183432e-10,
                        -3.582801014464574e-10,
                        1.275779736097027e-10,
                        3.7564709936634367e-13,
                        2.605254262672039e-12,
                        7.097532115369881e-10,
                    ],
                ]
                .into(),
            }),
        ...
        assert_relative_eq!(orbit.orbit_quality(), 0.45428360250957334, epsilon = tol);
    }
    ...
    // -------------------------------------------------------------------------
    {
        ...
        let expected = OrbitalElements::Equinoctial {
            elements: EquinoctialElements {
                reference_epoch: 57049.2684537375,
                semi_major_axis: 1.8018739009137108,
                eccentricity_sin_lon: 0.2694184716923517,
                eccentricity_cos_lon: 0.08942395295576266,
                tan_half_incl_sin_node: 0.0009019644496643635,
                tan_half_incl_cos_node: 0.10166078026904332,
                mean_longitude: 1.692434391840202,
            },
            uncertainty: Some(EquinoctialUncertainty {
                semi_major_axis: 2.3585132269664026e-6,
                eccentricity_sin_lon: 3.9194261900489564e-6,
                eccentricity_cos_lon: 1.5865593015190967e-5,
                tan_half_incl_sin_node: 7.219210267473514e-7,
                tan_half_incl_cos_node: 1.6844785191308778e-6,
                mean_longitude: 2.6515677695856968e-5,
            }),
            covariance: Some(OrbitalCovariance {
                matrix: [
                    [
                        5.562584641775474e-12,
                        -1.1223274582069844e-12,
                        3.586665434475061e-11,
                        -1.1878571558741382e-12,
                        1.8812844007639917e-12,
                        -6.038528224861774e-11,
                    ],
                    [
                        -1.1223274582069846e-12,
                        1.5361901659241675e-11,
                        -2.476740394836168e-11,
                        1.853744547260931e-12,
                        -5.874807576067024e-12,
                        3.895351123979577e-11,
                    ],
                    [
                        3.5866654344750586e-11,
                        -2.476740394836169e-11,
                        2.517170417236764e-10,
                        -9.547932489728067e-12,
                        1.850488095594953e-11,
                        -4.2047088886813246e-10,
                    ],
                    [
                        -1.1878571558741378e-12,
                        1.8537445472609303e-12,
                        -9.547932489728067e-12,
                        5.211699688599501e-13,
                        -1.0633352702278354e-12,
                        1.5788341319346446e-11,
                    ],
                    [
                        1.8812844007639893e-12,
                        -5.874807576067031e-12,
                        1.8504880955949528e-11,
                        -1.0633352702278354e-12,
                        2.8374678814133555e-12,
                        -3.016448219549987e-11,
                    ],
                    [
                        -6.038528224861772e-11,
                        3.895351123979577e-11,
                        -4.204708888681325e-10,
                        1.5788341319346446e-11,
                        -3.016448219549988e-11,
                        7.030811636705667e-10,
                    ],
                ]
                .into(),
            }),
        ...
        assert_relative_eq!(orbit.orbit_quality(), 1.8848492465715483, epsilon = tol);
    }
}
