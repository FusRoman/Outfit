...
fn test_diff_cor_nbody_nonregression() {
    ...
    // -------------------------------------------------------------------------
    {
        ...
        let expected = OrbitalElements::Equinoctial {
            elements: EquinoctialElements {
                reference_epoch: 60672.2443617134,
                semi_major_axis: 3.206405802848038,
                eccentricity_sin_lon: 0.053005209700784324,
                eccentricity_cos_lon: -0.023197692700649364,
                tan_half_incl_sin_node: 0.002896813138792766,
                tan_half_incl_cos_node: 0.09181010554057781,
                mean_longitude: 0.62569959044594,
            },
            uncertainty: Some(EquinoctialUncertainty {
                semi_major_axis: 0.007572375387331476,
                eccentricity_sin_lon: 0.0024777463038775966,
                eccentricity_cos_lon: 0.000744541864187889,
                tan_half_incl_sin_node: 4.278962581133368e-5,
                tan_half_incl_cos_node: 5.709061099412284e-5,
                mean_longitude: 0.003334899552842882,
            }),
            covariance: Some(OrbitalCovariance {
                matrix: [
                    [
                        5.734086900666352e-5,
                        1.869803680385367e-5,
                        5.597518329014607e-6,
                        -3.233584874913959e-7,
                        -4.2931838731305984e-7,
                        2.5017094733294615e-5,
                    ],
                    [
                        1.8698036803853682e-5,
                        6.139226746379091e-6,
                        1.8070842181301125e-6,
                        -1.0561767010998874e-7,
                        -1.409533929144513e-7,
                        8.251002205436103e-6,
                    ],
                    [
                        5.597518329014598e-6,
                        1.807084218130111e-6,
                        5.54342587528377e-7,
                        -3.149122788136571e-8,
                        -4.150037133410552e-8,
                        2.4017487424081015e-6,
                    ],
                    [
                        -3.2335848749139586e-7,
                        -1.0561767010998873e-7,
                        -3.149122788136571e-8,
                        1.830952077073954e-9,
                        2.437389741471458e-9,
                        -1.414633837922719e-7,
                    ],
                    [
                        -4.293183873130599e-7,
                        -1.409533929144513e-7,
                        -4.150037133410551e-8,
                        2.437389741471458e-9,
                        3.25933786368226e-9,
                        -1.894260739176938e-7,
                    ],
                    [
                        2.501709473329459e-5,
                        8.251002205436101e-6,
                        2.4017487424081015e-6,
                        -1.4146338379227188e-7,
                        -1.8942607391769378e-7,
                        1.1121555027551653e-5,
                    ],
                ]
                .into(),
            }),
